...
{meth}`.build_model()`. The model returned by the builder provides a couple of convenience features, for example, to evaluate the model log-probability, or to update the nodes in a topological order.
