...
The {meth}`.Model.plot()` method visualizes the model.
...
This fit conditions on the fixed variance. To estimate both coefficients and
variance, continue with {doc}`01c-transform`. The
{doc}`MCMC sampling guide <../../sampling>` links to configuration and diagnostics.
