...
We load the data set with pandas and use Python throughout the tutorial.
...
We load the `MASS::mcycle` data set from the [Rdatasets CSV collection](https://vincentarelbundock.github.io/Rdatasets/) into a pandas data frame.
