...
stable names, shapes, and dtypes. With the built-in :class:`.NegLogProbLoss` or
:class:`.NegElboLoss` and optimizers, anonymous internal nodes and constants do not
need stable names:
