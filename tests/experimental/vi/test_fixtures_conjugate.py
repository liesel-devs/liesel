...
def mvn_known_cov_prior_params():
    ...
    return {
        ...
        "covariance_matrix": 100.0 * jnp.eye(2)
    }
...
def mvn_known_cov_posterior_params(mvn_known_cov_data, mvn_known_cov_sigma):
    ...
    return {
        "loc": mu_prime,
        "covariance_matrix": sigma_prime
    }


@pytest.fixture
def mvn_known_cov_config():
    """Configuration for MV-Normal variational distribution using TriL parameterization with narrow variance."""
    return {
